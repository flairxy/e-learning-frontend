                    ...
                    <v-row>
                      ...
                      >
                        <v-img
                          width="100%"
                          :src="
                            form.image_url ? form.image_url : '/placeholder.png'
                          "
                        />
                      </v-col>
                      <v-col
...
export default {
  ...
  data() {
    return {
      options: [
        { name: 'Set As Featured Course', value: 'featured' },
        { name: 'Set As Top Course', value: 'top' }
      ],
      items: [
    ...
    setCourses() {
      this.$swal({
        ...
        if (result.value) {
          this.page = 1
          try {
            let set_type = this.set_type
            set_type === 'top'
              ? await CourseController.course.setTopCourse({
                  courses: this.selected
                })
              : await CourseController.course.setFeatured({
                  courses: this.selected
                })
            this.set_type = ''
            this.getCourses()
