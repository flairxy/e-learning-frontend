                  ...
                  <div class="d-flex justify-center py-5">
                    <v-badge color="none" overlap class="mr-5">
                      <v-btn
                        ...
                        icon
                        slot="badge"
                        @click.prevent="confirmDelete(currentVideo, 'videos')"
                      >
                    ...
                    <span v-for="file in currentDocuments" :key="file.id">
                      <v-badge color="none" overlap class="mr-6">
                        <v-btn
                          icon
                          slot="badge"
                          @click.prevent="confirmDelete(file.url, 'documents')"
                        >
                          <v-icon>mdi-trash-can-outline</v-icon>
                        </v-btn>

                        <a :href="file.url" download>
                          <img height="50" width="50" src="/file.png" alt="" />
                        </a>
                      </v-badge>
                    </span>
                  </div>
