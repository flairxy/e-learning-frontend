  ...
  <v-content>
    <v-container>
      <div>
        ...
        <p>Welcome to Invogeservices e-learn!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Invoge E-learn's Website, located at
          e-learning-demo.invogeservices.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Invogeservices e-learn if you do
        ...
        <p>
          We employ the use of cookies. By accessing Invogeservices e-learn, you
          agreed to use cookies in agreement with the Invoge E-learn's Privacy
          Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Invoge E-learn and/or its licensors own the
          intellectual property rights for all material on Invogeservices
          e-learn. All intellectual property rights are reserved. You may access
          this from Invogeservices e-learn for your own personal use subjected
          to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Invogeservices e-learn</li>
          <li>
            Sell, rent or sub-license material from Invogeservices e-learn
          </li>
          <li>
            Reproduce, duplicate or copy material from Invogeservices e-learn
          </li>
          <li>Redistribute content from Invogeservices e-learn</li>
        </ul>
        ...
        <p>
          ...
          Invoge E-learn does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Invoge E-learn,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Invoge E-learn
        ...
        <p>
          Invoge E-learn reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Invoge E-learn a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Invoge E-learn; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Invoge E-learn. Please include your name, your
        ...
        <p>
          No use of Invoge E-learn's logo or other artwork will be allowed for
